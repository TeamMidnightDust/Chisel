...
public class ChiselCarpet extends Block {

    public BlockItem blockItem;

    public ChiselCarpet(Material material, float hardness, float resistance, BlockSoundGroup sounds, ItemGroup group, String id) {
