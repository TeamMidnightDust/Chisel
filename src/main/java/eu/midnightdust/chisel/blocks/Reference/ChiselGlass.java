...
public class ChiselGlass extends Block {

    public BlockItem blockItem;

    public ChiselGlass(Material material, float hardness, float resistance, BlockSoundGroup sounds, ItemGroup group, String id) {
