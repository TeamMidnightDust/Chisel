...
public class ChiselBlock extends Block {

    public BlockItem blockItem;

    public ChiselBlock(Material material, float hardness, float resistance, BlockSoundGroup sounds, ItemGroup group, String id) {
